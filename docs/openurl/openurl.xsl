        ...
        document.onclick = cl;
            ...
            <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                <table width="100%" border="0" cellpadding="0" cellspacing="20">
                    ...
                    <tr valign="top">
                        <td><a href="/openurl/servlet/OAIHandler?verb=Identify">Repository Identification</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="/openurl/servlet/OAIHandler?verb=ListSets">Registry Entries</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="/openurl/docs/pdf/SubmittalProcess.pdf">Submittal Process</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="http://www.openurl.info/registry/docs/implementation_guidelines/">Implementation Guidelines</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="http://www.openurl.info/registry/docs/pdf/openurl-01.pdf">NISO OpenURL Version 0.1</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="http://alcme.oclc.org/openurl/servlet/OAIHandler/extension?verb=GetMetadata&amp;metadataPrefix=xsd&amp;identifier=info:ofi/fmt:xml:xsd:pro-2004">Community Profile XML Format</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="http://alcme.oclc.org/openurl/notes.html">Notes</a></td>
                    </tr>
                    <tr valign="top">
                        <td bgcolor="#cccccc">
