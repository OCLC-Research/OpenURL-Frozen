...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr valign="TOP">
                                    ...
                                    <td colspan="3">
                                        <h1>Registry for the OpenURL Framework - ANSI/NISO Z39.88-2004</h1>
                                    </td>
                                    <!--
    ...
    <xsl:template match="oai:setName">
        <td><strong><a><xsl:attribute name="href"><xsl:value-of select="translate(., ' ', '')"/>/ListRecords.oai_dc.xml</xsl:attribute>
    ...
    <xsl:template match="text()" mode="verbose">
        <xsl:if test="string-length(normzlize=space(.)) &gt; 0">
            <DIV class="e">
                <SPAN class="b">&#160;</SPAN>
